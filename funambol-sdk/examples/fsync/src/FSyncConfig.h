...
#define FSYNC_CACHEDIR_PROPERTY       "cacheDir"
...
public:
    ...
    const StringBuffer& getCacheDir() const { return cacheDir; };

    /** Set a new cache dir */
    void setCacheDir(const char *newCacheDir);
