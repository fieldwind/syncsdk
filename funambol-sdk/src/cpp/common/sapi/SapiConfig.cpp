...
void SapiConfig::setSapiVersion(const char* v) {
    setProperty(PROPERTY_SAPI_VERSION, v);
}
...
const char* SapiConfig::getSapiVersion() {
    return getProperty(PROPERTY_SAPI_VERSION);
}
