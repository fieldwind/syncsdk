...
SyncItemEvent::SyncItemEvent(const WCHAR* key, const char* name, const char* uri, 
                             int type, unsigned long date, const int data) : BaseEvent(type, date) {
