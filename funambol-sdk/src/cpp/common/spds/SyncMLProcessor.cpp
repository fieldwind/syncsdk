...
ArrayList* SyncMLProcessor::processGetCommand(AbstractCommand* cmd, DevInf* devInf, SyncMLBuilder& syncMLBuilder) {
...
ArrayList* SyncMLProcessor::processPutCommand(AbstractCommand* cmd, AbstractSyncConfig& config, SyncMLBuilder& syncMLBuilder) {
