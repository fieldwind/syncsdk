...
ModificationCommand::ModificationCommand(CmdID* cmdID, Meta* meta, ArrayList* items)
                    : ItemizedCommand(cmdID, meta, items) {
 ...
 */
ModificationCommand::ModificationCommand(CmdID* cmdID, ArrayList* items)
