...
#include "MHFileItemsStore.h"
#include "MHFileSyncItemInfo.h"

BEGIN_FUNAMBOL_NAMESPACE

MHFileItemsStore::MHFileItemsStore(const char* storeName, const char* storePath,
                                   int funambolSavedVersionNumber,
                                   int funambolCurrentVersionNumber,
                                   bool init) : MHItemsStore(storeName, storePath, funambolSavedVersionNumber, funambolCurrentVersionNumber, init)
{
    
}

MHStoreEntry* MHFileItemsStore::createEntry(unsigned long id_,
                                        const char* guid,
                                        const char* luid,
                                        const char* name,
                                        size_t size,
...
{
    return new MHFileSyncItemInfo(id_, guid, luid, name, size, serverUrl, contentType,
