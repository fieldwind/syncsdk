...
BufferInputStream::BufferInputStream(const void* data, const int64_t dataSize) : InputStream() {
...
int64_t BufferInputStream::read(void* buffer, const int64_t size) {
...
int64_t BufferInputStream::getPosition() {
    return position;
}

int BufferInputStream::setPosition(const int64_t offset) { 
