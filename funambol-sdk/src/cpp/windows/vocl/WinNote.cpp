...
wstring WinNote::toString() {
    ...
    vo->addProperty(TEXT("BEGIN"), TEXT("VNOTE"));
    vo->addProperty(TEXT("VERSION"), VNOTE_VERSION);
    ...
    if (getProperty(L"Color", element)) {
        ...
        vo->addProperty(TEXT("X-FUNAMBOL-COLOR"), colorName[color]);
    }
    ...
    vo->addProperty(TEXT("END"), TEXT("VNOTE"));   
