...
public:
    ...
    void setAllDayEvent(bool v)    { allDayEvent = v; recurrence.setAllDay(v);    }
...
//    void setRecurrence(const AppleRecurrence& r) { recurrence = r; }
    AppleRecurrence& getRecurrence()  { return recurrence; }
    
  void setExclusions(NSArray *e) {
    [exclusions addObjectsFromArray:e];
  }
  
  NSMutableArray * getExclusions() const { 
    return exclusions; 
  }
};
