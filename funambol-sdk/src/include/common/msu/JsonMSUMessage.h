...
class JsonMSUMessage
{
    ...
    public:
        ...
        bool parseSignUp(const char* message, std::string& serverErrorMsg);
        bool parseFieldsToCheckValidity(const char* message, std::string *customErrMsg);
        /**
        ...
        /**
         * @return new allocated buffer containing the body of the fields to check, NULL in case of error
         */
        const char* formatFieldsToCheckValidity(const char* username, const char* password, const char* language,
