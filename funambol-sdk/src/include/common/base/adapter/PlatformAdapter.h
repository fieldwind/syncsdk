...
public:
    ...
    static void init(const char *appcontext, const bool force = false) {
		init(appcontext, true, force);
	}

	static void init(const char *appcontext, bool useSlashSeparator, const bool force);
     ...
     * @return none
     */
    static void init(const char *appcontext, bool useSlashSeparator, StringMap& env, const bool force = false);

	static void init(const char *appcontext, StringMap& env, const bool force) {		
		init(appcontext, true, env, force);
	}
