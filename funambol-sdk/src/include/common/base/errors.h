...
#define ERR_CLIENT_QUOTA_EXCEEDED       ERR_GENERIC_BASE + 14
#define ERR_SYNC_METHOD_NOT_SUPPORTED   ERR_GENERIC_BASE + 15
#define ERR_OPERATION_CANCELED          ERR_GENERIC_BASE + 16
