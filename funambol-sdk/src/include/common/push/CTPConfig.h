...
private:
    ...
    */
    ...
    /**
     * By default the value is 0 that means the username/password are stored in clear mode
     * in the client configuration
     * 1: just the password must be decrypted from the AccessConfig 
     * 2: just the username must be decrypted from the AccessConfig 
     * 3: both username/password must be decrypted from the AccessConfig
     */
    int dataEncrypted;
...
public:        
    ...
    */
    ...
    /**
    * set/get method for nonce parameter
    */
    StringBuffer& getCtpNonce()      { return ctpNonce; }
    void setCtpNonce(StringBuffer v) { ctpNonce = v; }
    ...
    */
    ...
    void setDataEncrypted(int val) { dataEncrypted = val; }
    int getDataEncrypted() { return dataEncrypted; }
};
