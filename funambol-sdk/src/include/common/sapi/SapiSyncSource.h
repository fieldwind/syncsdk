...
public:
    ...
    */
    ...
    virtual bool checkAllLocalItems     (AbstractSyncConfig& mainConfig) { return false; }
    virtual bool checkModifiedLocalItems(AbstractSyncConfig& mainConfig);
    ...
    /**
     * recursive scanning property getter/setter
     */
...
protected:
    ...
    bool filterFromBlackList(StringBuffer& guid);
