...
class AbstractSyncConfig {
 public:
    ...
    virtual AbstractSyncSourceConfig* getAbstractSyncSourceConfig(const char* name) = 0;
    virtual AbstractSyncSourceConfig* getAbstractSyncSourceConfig(unsigned int i) = 0;
     ...
     * 
     */
    virtual const char* getCredInfo() const = 0;
    virtual void setCredInfo(const char* credInfo_) =0;
    /**
    ...
    virtual  const char*  getPhoneidentify() const = 0;
    virtual  const char*  getTokenauth() const = 0;
    
    //    virtual void setPhoneidentify(const char*  phoneidentify) = 0;
    //    virtual void setTokenauth(const char*  tokenauth) = 0;
    ...
    /** True if transport-level compression is enabled */
    ...
    /// Specifies if the Server supports upload of media files via HTTP.
    virtual void setServerMediaHttpUpload(const bool v) = 0;
   
    // set the source uri list comma separated for replace or not the item
    virtual void setServerNoFieldLevelReplace(const char* v) = 0;
    ...
    /// Returns the global error code of last sync
    virtual unsigned long getInstallationTimestamp() = 0;

    /// Sets the global last error code
    virtual void setInstallationTimestamp(unsigned long val) = 0;
    
    
    //
    // getters/setters for MediaHub media sync
    //
    virtual int getMHRequestTimeout() = 0;
    virtual int getMHResponseTimeout() = 0;
    virtual int getMHUploadChunkSize() = 0;
    virtual int getMHDownloadChunkSize() = 0;
    virtual int getMHMaxRetriesOnError() = 0;
    virtual long getMHSleepTimeOnRetry() = 0;
    virtual bool getMHResetStreamOnRetry() = 0;
    virtual long getMHMinDataSizeOnRetry() = 0;
    
    virtual void setMHRequestTimeout   (const int v) = 0;
    virtual void setMHResponseTimeout  (const int v) = 0;
    virtual void setMHUploadChunkSize  (const int v) = 0;
    virtual void setMHDownloadChunkSize(const int v) = 0;
    virtual void setMHMaxRetriesOnError(const int v) = 0;
    virtual void setMHSleepTimeOnRetry(const long v) = 0;
    virtual void setMHResetStreamOnRetry (bool v)    = 0;
    virtual void setMHMinDataSizeOnRetry(const long v) = 0;
    
    virtual const char* getSessionId() const                        = 0;
    virtual void setSessionId(const char* sessionId)                = 0;
    virtual time_t getSessionIdSetTime() const                      = 0;
    virtual void setSessionIdSetTime(time_t setTime)                = 0;
    virtual time_t getSessionIdExpirationTime() const               = 0;
    virtual void setSessionIdExpirationTime(time_t expirationTime)  = 0;
    virtual const char* getValidationKey() const                    = 0;
    virtual void setValidationKey(const char* validationKey)        = 0;
    
    
    //
    // getters/setters for SAPI media sync (v10 backward compatibility)
    //
    virtual int getSapiRequestTimeout() = 0;
    virtual int getSapiResponseTimeout() = 0;
    virtual int getSapiUploadChunkSize() = 0;
    virtual int getSapiDownloadChunkSize() = 0;
    virtual int getSapiMaxRetriesOnError() = 0;
    virtual long getSapiSleepTimeOnRetry() = 0;
    virtual bool getSapiResetStreamOnRetry() = 0;
    virtual long getSapiMinDataSizeOnRetry() = 0;
    virtual const char* getSapiVersion() = 0;
    
    virtual void setSapiRequestTimeout   (const int v) = 0;
    virtual void setSapiResponseTimeout  (const int v) = 0;
    virtual void setSapiUploadChunkSize  (const int v) = 0;
    virtual void setSapiDownloadChunkSize(const int v) = 0;
    virtual void setSapiMaxRetriesOnError(const int v) = 0;
    virtual void setSapiSleepTimeOnRetry(const long v) = 0;
    virtual void setSapiResetStreamOnRetry (bool v)    = 0;
    virtual void setSapiMinDataSizeOnRetry(const long v) = 0;
    virtual void setSapiVersion(const char* v) = 0;
    
    
    virtual void setAuthenticationType(const char* authType) = 0;
    virtual const char* getAuthenticationType() const        = 0;

    //
    // OAuth2 support
    //
    virtual void setOAuth2AccessToken(const char* accessToken)   = 0;
    virtual void setOAuth2AccessTokenSetTime(time_t setTime)     = 0;
    virtual void setOAuth2RefreshToken(const char* refreshToken) = 0;
    virtual void setOAuth2ClientType(const char* clientType)     = 0;
    virtual void setOAuth2ExpiresIn(const char* expiresIn)       = 0;
    virtual void setOAuth2Scope(const char* scope)               = 0;
   
    virtual const char* getOAuth2AccessToken(void)   const       = 0;
    virtual time_t getOAuth2AccessTokenSetTime(void) const       = 0;
    virtual const char* getOAuth2RefreshToken(void)  const       = 0;
    virtual const char* getOAuth2ExpiresIn(void)     const       = 0;
    virtual const char* getOAuth2ClientType(void)    const       = 0;
    virtual const char* getOAuth2Scope(void)         const       = 0;

    void setOauth2Params(OAuth2Credentials credentials, time_t setTime)
    {
        this->setOAuth2AccessTokenSetTime(setTime);
        this->setOAuth2AccessToken (credentials.getAccessToken());
        this->setOAuth2RefreshToken(credentials.getRefreshToken());
      //this->setOAuth2ClientType  (credentials.getClientType());
      //this->setOAuth2Scope       (credentials.getScope());

        StringBuffer expiresInStr;
        expiresInStr.sprintf("%d", credentials.getExpiresIn());
        this->setOAuth2ExpiresIn(expiresInStr);
    }

    // wassup support
    virtual void setWassupAuthToken(const std::string& authToken) = 0;
    virtual const char* getWassupAuthToken(void)   const          = 0;
