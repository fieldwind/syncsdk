    ...
    public:
       ...
       /**
        ...
        struct encodings {
            ...
            static const char* const des;      /**< encrypted with DES and then base64 encoded */
            ...
            static bool isSupported(const char* encoding) {
        ...
        virtual int getSyncStatus() const;
        
        virtual void setSyncStatus(int syncStatus);
      private:
