...
BEGIN_NAMESPACE
    ...
    public:
        ...
        */
         ...
         */
        ArrayList* processGetCommand(AbstractCommand* cmd, DevInf* devInf, SyncMLBuilder& syncMLBuilder);
         ...
         * @return       new allocated ArrayList of commands to be added in the response msg
         */
        ArrayList* processPutCommand(AbstractCommand* cmd, AbstractSyncConfig& config, SyncMLBuilder& syncMLBuilder);
        ...
        */
         ...
         */
        int processItemStatus(SyncSource& source, SyncBody* syncBody, SyncItemKeys& syncItemKeys);
