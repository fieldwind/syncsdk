...
public:
    ...
    */
    virtual void setProperty(const char* propertyName, const char* propertyValue);
    ...
    */
    ...
    void setLongLongProperty(const char* propertyName, long long propertyValue);
    /**
    ...
    */
    ...
    long long getLongLongProperty(const char* propertyName, bool *err);    
