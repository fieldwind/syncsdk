...
BEGIN_NAMESPACE
    ...
    public:
        ...
        void setOAuth2AccessTokenSetTime(const time_t timestamp);
        void setOAuth2Credentials(const char* accessToken, const char* refreshToken,
                                  const char* clientType, bool valid = false, int expiresIn = 0);

        void setOAuth2Credentials(const char* jsonCredentials);

        const OAuth2Credentials& getOAuth2Credentials();
    };
