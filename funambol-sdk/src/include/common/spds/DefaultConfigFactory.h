...
class DefaultConfigFactory {
    ...
    public:
        ...
        /**
         * Returns a default generated SapiConfig.
         * This method should be overridden to get a default client-specific SapiConfig.
        ...
        /**
         * Returns a default generated MHConfig.
         * This method should be overridden to get a default client-specific MHConfig.
         * @return: MHConfig pointer allocated new, so it must
         *          be freed by the caller.
         */
        static MHConfig*     getMHConfig();
