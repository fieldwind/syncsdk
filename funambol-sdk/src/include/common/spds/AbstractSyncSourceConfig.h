...
class AbstractSyncSourceConfig {
 public:
    ...
    virtual void setEndSyncTime(unsigned long timestamp) = 0;
    virtual unsigned long getEndSyncTime() = 0;
    
    virtual void setBeginSyncTime(unsigned long timestamp) = 0;
    virtual unsigned long getBeginSyncTime() = 0;
    ...
    virtual int getLastSourceError() const { return 0; };

    /// Sets the sync source's last error code.
    virtual void setLastSourceError(const int /*errorCode*/) {};

    /**
     * Gets the server last sync time for this source
     */
    virtual unsigned long getLastSyncServerTime() const { return 0; }
    
    /**
     * Sets the server last sync time for this source
     */
    virtual void setLastSyncServerTime(unsigned long value) {}
};
