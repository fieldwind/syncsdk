 ...
 */
class ManagementNode : public ConfigurationNode {
    ...
    public:
         ...
         *                      NOTE: the fullcontext MUST contain at least one "/" char
         *                            to correctly split context and name.
         *
         */
         ...
         */
        virtual void addChild(ConfigurationNode *child);
         ...
         */
        virtual StringMap* readAllProperties();
        /*
         ...
         */
       virtual int deleteProperty(const char* keyName);
