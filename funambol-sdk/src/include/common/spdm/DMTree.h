...
class DMTree : public ConfigurationTree {
    ...
    public:
         ...
         *
         * The ConfigurationNode is created with the new operator and must be
         * deallocated by the caller with the operator delete.
         */
        virtual ConfigurationNode* readManagementNode(const char* node);
         ...
         */
        virtual ConfigurationNode* readManagementNode(const char* context, const char* name);

        virtual ConfigurationNode* getNode(const char* node);

        void refreshNodeChildren(ConfigurationNode *n);
    
        ConfigurationNode* createConfigurationNode(const char* parent, const char* name);
    
        bool checkNodeExistence(const char* fullName);
