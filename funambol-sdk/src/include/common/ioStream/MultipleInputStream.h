...
protected:
     ...
     */
    virtual int64_t readFromStream(InputStream* stream, void* buffer, const int64_t size);
...
public:
     ...
     */
    virtual int64_t read(void* buffer, const int64_t size);
    ...
    /**
     * The function returns a non-zero value if the stream's error flag 
     * has been set by a previous i/o operation.
     */
    int error();
     ...
     */
    int setPosition(const int64_t offset);
