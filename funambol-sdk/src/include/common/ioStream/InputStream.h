...
public:
    ...
    /**
     * The function returns a non-zero value  if the eofbit stream's flag has been 
    ...
    /**
     * The function returns a non-zero value  if the stream's error flag has been 
     * set by a previous i/o operation. 
     */
    virtual int error();
     ...
     */
    virtual int setPosition(const int64_t offset) = 0;
