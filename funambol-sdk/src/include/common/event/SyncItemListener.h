...
public:
    ...
    /// listen for the Media Item uploading Event
    /// This event is fired by SapiSyncManager, before uploading an item
    virtual void itemUploading(SyncItemEvent& /* event */);

    /// listen for the Media Item uploaded Event
    /// This event is fired by SapiSyncManager, when upload is complete
    virtual void itemUploaded(SyncItemEvent& /* event */);

    /// listen for the Media Item downloading Event
    /// This event is fired by SapiSyncManager, before downloading an item
    virtual void itemDownloading(SyncItemEvent& /* event */);

    /// listen for the Media Item downloaded Event
    /// This event is fired by SapiSyncManager, when download is complete
    virtual void itemDownloaded(SyncItemEvent& /* event */);
};
