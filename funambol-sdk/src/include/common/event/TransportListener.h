...
public:
    ...
    // listen for Sending Data 
    virtual void sendingData(TransportEvent& /* event */) {};
    ...
    // listen for partial data eventually already exchanged (download or upload)
    virtual void partialData(TransportEvent& /* event */) {};
