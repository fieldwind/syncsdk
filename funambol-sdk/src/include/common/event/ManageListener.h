...
#include "event/ItemStatusListener.h"
...
public:
    ...
    ItemStatusListener* getItemStatusListener(const char *name = "");
    ItemStatusListener* getItemStatusListener(int pos);
    ...
    void setItemStatusListener(ItemStatusListener* listener);
    ...
    void unsetItemStatusListener(const char *name = "");
    ...
    int countItemStatusListeners() const { return itemstatuslisteners.size(); }
