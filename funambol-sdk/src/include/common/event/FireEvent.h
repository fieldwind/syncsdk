 ...
 */
bool fireSyncItemEvent(const char* sourceURI, const char* name, const WCHAR* itemKey, int type, int data = 0);
...
/*
 * Fire a MediaHub ItemStatusEvent.
 * @param MHItemInfo : the item info class
 * @param type         : the the type of event to fire (see event/constants.h)
 */
