...
public:
    ...
    // listen for resetting local items event.
    virtual void syncSourceResetting (SyncSourceEvent& /* event */) {};

    /// listen for source operation retrying.
    virtual void syncSourceRetry (SyncSourceEvent& /* event */) {};
    
    // listen for the metadata sync Begin Event
    virtual void metadataSyncBegin(SyncSourceEvent& /* event */) {};
    
    // listen for the metadata sync End Event
    virtual void metadataSyncEnd(SyncSourceEvent& /* event */) {};
    
    virtual void syncSourceUploadPhaseStarted(SyncSourceEvent& event)           {};
    virtual void syncSourceUploadPhaseEnded(SyncSourceEvent& event)             {}; 
    virtual void syncSourceDownloadPhaseStarted(SyncSourceEvent& event)         {};
    virtual void syncSourceDownloadPhaseEnded(SyncSourceEvent& event)           {};
};
