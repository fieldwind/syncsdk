...
BEGIN_FUNAMBOL_NAMESPACE
    ...
    protected:
        ...
        char * sendBuffer(const void * data, const unsigned int length);

    public:
        CurlTransportAgent();
        CurlTransportAgent(const URL& url, Proxy& proxy, unsigned int responseTimeout = DEFAULT_MAX_TIMEOUT);
        ~CurlTransportAgent();
