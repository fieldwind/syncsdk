 ...
 * server is localhost with user/pass guest/guest.
 */

BEGIN_NAMESPACE

/**
 * just a small HttpConnection wrapper class to have access to 
 * server HTTP response headers
 lass HttpConnection2 : public HttpConnection 
{
    public:
        const StringMap& getResponseHeaders() const { return responseHeaders; }

};
*/

class HttpConnectionTest : public CppUnit::TestFixture 
{
    public:
        HttpConnectionTest();
