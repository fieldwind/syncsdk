...
public:
    ...
    public:
        ...
        TSyncItemListener(const char *name): SyncItemListener(name),ListenerTest(7) {};
        ...
        void itemUploadedByClient(SyncItemEvent& event){counter++;};
...
private:
    ...
    void testSyncItemEvent() {
        ...
        fireSyncItemEvent(uri, name, key, ITEM_UPLOADED_BY_CLIENT);
