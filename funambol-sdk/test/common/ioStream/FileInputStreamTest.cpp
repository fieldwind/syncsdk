...
class FileInputStreamTest : public InputStreamTest {
    ...
    CPPUNIT_TEST(testFileStreamPosition);
...
private:
    ...
    void testFileReadBigChunk() {
        ...
        size_t fileSize3 = stream3.getTotalSize();
        testReadBigChunk(stream3, fileContent3, (int)fileSize3);
        stream3.close();
    }
    ...
    void testFileReadTwoChunks() {
        ...
        FileInputStream stream3(fileName3);
        size_t fileSize3 = stream3.getTotalSize();
        testReadTwoChunks(stream3, fileContent3, (int)fileSize3);
        stream3.close();
    }
    ...
    void testFileReadManyChunks() {
        ...
        FileInputStream stream3(fileName3);
        int fileSize3 = (int)stream3.getTotalSize();
    ...
    void testFileStreamPosition() {

        FileInputStream stream(fileName1);
        
        int offset = 5;
        int size = 50;
        testStreamPosition(stream, fileContent1, offset, size);
