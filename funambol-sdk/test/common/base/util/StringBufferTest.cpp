...
class StringBufferTest : public CppUnit::TestFixture {
    ...
    CPPUNIT_TEST(testTrimChr);
    CPPUNIT_TEST(testStringBufferCopyConstructor);
...
#define TEST_STRING  "Quant'è bella giovinezza.."
    ...
    void testStringBufferCopyConstructor() {
        StringBuffer s1("testString");
        StringBuffer s2(s1);

        CPPUNIT_ASSERT(s1 == s2);
        CPPUNIT_ASSERT(s1.length() == 10);
        ...
        CPPUNIT_ASSERT(s3.length() == 0);
        CPPUNIT_ASSERT(s4.length() == 0);

        StringBuffer s5(NULL);
        StringBuffer s6(s5);  
        CPPUNIT_ASSERT(s5 == s6);
        
        StringBuffer s7(NULL);
        StringBuffer s8("");
        CPPUNIT_ASSERT(s7 != s8);
    ...
    //////////////////////////////////////////////////////// Test /////
    // Test the trim function with different characters
    void testTrimChr() {
        StringBuffer s1("  \t   Sentence to trim  \n ");
        StringBuffer s2("");        
        ...
        CPPUNIT_ASSERT(s1.trim() == "\t   Sentence to trim  \n");
        CPPUNIT_ASSERT(s1.trim('\n') == "\t   Sentence to trim  ");
        CPPUNIT_ASSERT(s1.trim() == "\t   Sentence to trim");
        CPPUNIT_ASSERT(s1.trim('\t') == "   Sentence to trim");        
        CPPUNIT_ASSERT(s1.trim() == "Sentence to trim");        
        CPPUNIT_ASSERT(s2.trim('a') == "");
        CPPUNIT_ASSERT(s3.trim('\n') == NULL);
    }
