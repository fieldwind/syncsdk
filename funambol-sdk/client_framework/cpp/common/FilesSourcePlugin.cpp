...
const char* FilesSourcePlugin::item_store_name       = "file_items";
const char* FilesSourcePlugin::temporary_item_folder = "mediahub_spool_file";
const char* FilesSourcePlugin::sapi_uri              = "file";
const char* FilesSourcePlugin::sapi_array_key        = "files";
SourcePlugin::OrderField FilesSourcePlugin::order_field            = orderByModificationDate;;

FilesSourcePlugin::FilesSourcePlugin(const char* tag, const char* label, const char* name, 
